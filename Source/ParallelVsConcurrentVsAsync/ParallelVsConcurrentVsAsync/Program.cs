 ...
 * - Make sure to start Test API before running asynchronous tasks test.
 * - I recommend using Release build of this console app to run the tests.
 */
public class Program
{
    ...
    static void TestCPUBoundTasks()
    {
        ...
        sw.Stop();
        Console.WriteLine($"Synchronous execution took: {sw.ElapsedMilliseconds}ms, {sw.ElapsedTicks}ticks");
        ...
        // sw.Stop();
        // Console.WriteLine($"Parallel execution took: {sw.ElapsedMilliseconds}ms, {sw.ElapsedTicks}ticks");
        ...
        // sw.Stop();
        // Console.WriteLine($"Concurrent execution took: {sw.ElapsedMilliseconds}ms, {sw.ElapsedTicks}ticks");
    }

    static void TestAsynchronousTasks()
    {
        // Before running these tests make sure you started Test API 
        // You can build and start it by using `dotnet run` inside TestAPI directory
        ...
        // sw.Stop();
        // Console.WriteLine($"Asynchronous execution took: {sw.ElapsedMilliseconds}ms, {sw.ElapsedTicks}ticks");
        ...
        // sw.Stop();
        // Console.WriteLine($"Parallel+Concurrent execution took: {sw.ElapsedMilliseconds}ms, {sw.ElapsedTicks}ticks");
